...
const props = defineProps<{ messages: ChatMessage[]; peerId: string }>();
...
<template>
  <div class="w-[260px] bg-black border-l-2 border-[var(--color-border)] flex flex-col">
    ...
    <div ref="messagesEl" class="flex-1 overflow-y-auto">
      ...
      <div v-if="messages.length === 0" class="p-4 text-center text-[var(--color-muted)] text-xs">No messages yet</div>
    </div>
